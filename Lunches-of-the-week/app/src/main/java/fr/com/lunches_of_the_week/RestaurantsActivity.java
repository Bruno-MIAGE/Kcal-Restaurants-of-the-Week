...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // récupération des jeux de repas se rapprochant à plus ou moins le pourcentage donné de la valeur donnée par l'utilisateur "givenNumberOfKcal"
    ...
    public static void subsetRestaurants(double givenNumberOfKcal, double nbLunch, Integer percent, HashSet<List<Restaurant>> resultats, List<Restaurant> restaurants){
        ...
        // On vérifie si la somme s'approche de la valeur voulue à + ou - le pourcentage donné et que l'on a bien le nombre de repas souhaité
